      ...
      <div class="modal-body">
       <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input v-model="inputData.specialitie" type="text" id="first-name" class="form-control col-md-7 col-xs-12">
             <span v-if="formErrors['specialitie']" class="error text-danger">{{ formErrors['specialitie']['0'] }}</span> 
          </div>
        </div>
      </div>
